...
const validateUpdateMaltratoAnimal = [
    ...
    body("atencionVeterinaria").
        optional().isIn(['Si','No','No Sabe']),
    body("relacionAnimal").
        optional().isIn(['Propietario','Guardian','Medico Veterinario','Vecino','Otro']),
    body("tipoAnimal").
        optional().isIn(['Domestico','Exotico','Silvestre']),
    body("tomoConocimiento").
        optional().isIn(['Le Contaron','Noticias','Redes Sociales','Testigo Presencial']),
    ...
    body("violenciaCometida").
        optional().isIn(['Propietario','Familiar del Propietario','Vecino','Guardian','Persona Mayor de Edad','Persona Menor de Edad','Otro']),
    body("abusoAnimal").
        optional().isIn(['Si','No','No Sabe']),
