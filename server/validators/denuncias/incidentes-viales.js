...
const validateUpdateIncidentesViales = [
  ...
  body('cantVehiculos').optional().isNumeric(),
  (req, res, next) => {
...
const validateUpdateIncidentesVialesVehiculos = [
  body('*.idDenunciaAutomovilesTipo').optional().isNumeric(),
  body('*.idDenunciaAutomovilesMarca').optional().isNumeric(),
  body('*.modelo').optional(),
  body('*.dominio').optional(),
  body('*.anioFabricacion').optional(),
  body('*.numMotor').optional(),
  body('*.puertas').optional(),
  body('*.titular').optional(),
  body('*.gnc').optional(),
