        ...
        <div className='grid mt-6'>
          <div className='col-12 lg:col-6' id='datos-generales'>
            ...
            <p className='font-bold'>
              Fecha:{' '}
              <span className='font-normal'>
                {parseDDMMYYYYHHMM(resumen.fechaDenuncia, resumen.horaDenuncia)}
              </span>
            </p>
            <p className='font-bold'>
              Tipo: <span className='font-normal'>{resumen.tipoDenuncia}</span>
            </p>
          </div>
            ...
            {resumen.certezaLugar === 1 ? (
              <div className=''>
                <p className='font-bold'>
                  ...
                  <span className='font-normal'>
                    {parseDDMMYYYYHHMM(resumen.fechaHecho, resumen.horaHecho)}
                  </span>
                </p>
              </div>
            ) : (
