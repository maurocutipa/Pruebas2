...
export default function MapTemplate(props) {
  ...
  const onClick = (e) => {
    ...
    var coord = JSON.stringify(e.latLng, null, 2)
    props.changeCoord(coord);
  };
  ...
  return (
    <div style={{ display: "flex", height: "50vh" }}>
      <Wrapper apiKey={"AIzaSyB9XerbY6zq1u0LZYj-LYq47n3Pkkn2vXU"} render={render}>
        <Map
          center={props.center}
          onClick={onClick}
          onIdle={onIdle}
