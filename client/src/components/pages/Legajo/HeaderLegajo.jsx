    ...
    <>
      <div className="grid">
        ...
        <div className="col-2 md:hidden">
          <Button icon="pi pi-arrow-left" onClick={() => setVisibleRight(true)} style={{ minHeight: 69}}/>
        ...
        <div className="hidden md:block md:col-12 lg:col-12 xl:col-8 pb-0">
          <div className="grid">
            <div className="col-5 xl:col-5 pb-0">
              <div className="grid">
                <div className="col-5 xl:col-5">
                  <Button label="2 Pendientes" icon='pi pi-calendar' className="w-12 bg-white hover:bg-gray-200 text-xs" severity="secondary" outlined style={{ minHeight: 69, padding: '0 10px' }} text raised
                    tooltip="Ir a pendientes" tooltipOptions={{ position: 'bottom' }}
                  />
                </div>
                <div className="col-7 xl:col-7">
                  <Button label="Vencimiento de IPP en 3 dias" className="w-12 bg-white hover:bg-gray-200 text-sm" severity="danger" outlined style={{ minHeight: 69, color: '#E00000', padding: '0 10px' }} text raised
                    tooltip="Ir a pendientes" tooltipOptions={{ position: 'bottom' }} />
                </div>
              </div>
            </div>
            <div className="col-7 xl:col-7 pb-0">
              <div className="grid">
                <div className="col-7 xl:col-7">
                  <Button label="Vencimiento de Prision Preventiva: 2 días" className="w-12 text-sm bg-white hover:bg-gray-200" severity="danger" outlined style={{ minHeight: 69, color: '#E00000' }} text raised
                    tooltip="Ir a pendientes" tooltipOptions={{ position: 'bottom' }} />
                </div>
                <div className="col-5 xl:col-5">
                  <Button label="Otros Vencimientos" className="w-12 text-sm bg-white hover:bg-gray-200" severity="danger" outlined style={{ minHeight: 69, color: '#E00000' }} text raised
                    tooltip="Ir a pendientes" tooltipOptions={{ position: 'bottom' }} />
                </div>
              </div>
            </div>
