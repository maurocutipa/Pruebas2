...
export const VehiculosInvolucradosTable = () => {
    const [globalFilterValue, setGlobalFilterValue] = useState('');
    const [resetFilters, setResetFilters] = useState(false);

    const [vehiculosInvolucradosData, setVehiculosInvolucradosData] = useState([]);
    ...
    return (
        <>
            ...
            <DataTable
                value={vehiculosInvolucradosData}
                paginator
                rows={5}
                totalRecords={vehiculosInvolucradosData.length} // Actualiza con el total de registros
            ...
            <Button label='Agregar Vehículo Involucrado' />
        </>
    );
};
